...
const INSTALL_COMMAND = "npx --yes \"https://cm.fldr.zip/downloads/codemask-bridge.tgz?bridge=0.1.4\"";
...
function Onboarding() {
  ...
  const email = runtime.data?.value?.profile?.email as string | null | undefined;
